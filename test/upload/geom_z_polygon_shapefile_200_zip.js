...
module.exports = function () {
    ...
    describe('Import', function () {
        ...
        describe(endpoints.import.post, function () {
            ...
            context('geom_z.polygon.shapefile.200.zip', function () {
                this.timeout(21000);
                ...
                it('upload', function (done) {
                    token(function (err, access_token) {
                        api.post(endpoints.import.post)
                            ...
                            .field('data', fs.createReadStream(path.resolve(__dirname, '../open-data/geom_z.polygon.shapefile.200.zip')))
                            ...
                            .end(function (err, res) {
                                ...
                                expect(result.filename).to.be.equal('geom_z.polygon.shapefile.200.zip');
            ...
            token(function (err, access_token) {
                api.get(endpoints.import.status)
                    ...
                    .end(function (err, res) {
                        ...
                        expect(status.rows_count).to.be.equal('191');
            ...
            token(function (err, access_token) {
                ...
                api.get(endpoints.import.download)
                    ...
                    .end(function (err, res) {
                        ...
                        expect(result.file.originalName).to.be.equal('geom_z.polygon.shapefile.200.zip');
                        expect(result.file.name).to.be.equal('geom_z.polygon.shapefile.200');
                        done();
                    });
            });
        });
