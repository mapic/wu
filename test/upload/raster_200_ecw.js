...
module.exports = function () {
    ...
    describe('Import', function () {
        ...
        describe(endpoints.import.post, function () {
            ...
            context('raster.200.ecw', function () {
                this.timeout(21000);
                ...
                it('upload', function (done) {
                    token(function (err, access_token) {
                        api.post(endpoints.import.post)
                            ...
                            .field('data', fs.createReadStream(path.resolve(__dirname, '../open-data/raster.200.ecw')))
                            ...
                            .end(function (err, res) {
                                ...
                                expect(result.filename).to.be.equal('raster.200.ecw');
            ...
            token(function (err, access_token) {
                api.get(endpoints.import.status)
                    ...
                    .end(function (err, res) {
                        ...
                        expect(status.filename).to.be.equal('raster.200.ecw');
            ...
            token(function (err, access_token) {
                ...
                api.get(endpoints.import.download)
                    ...
                    .end(function (err, res) {
                        ...
                        expect(result.file.originalName).to.be.equal('raster.200.ecw');
                        expect(result.file.name).to.be.equal('raster.200');
                        done();
                    });
            });
        });
